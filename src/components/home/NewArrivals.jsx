  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-br from-gray-50 via-white to-indigo-50/30">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-sm border border-white/60 rounded-full px-6 py-2 text-indigo-600 text-sm font-medium shadow-lg mb-4">
            <FaFire className="text-orange-500" />
            <span>មកដល់ថ្មីៗ</span>
          </div>
        ...
        <AnimatePresence mode="wait">
          {products.length === 0 ? (
            ...
            >
              <p className="text-gray-500">មិនទាន់មានផលិតផលថ្មីនៅឡើយទេ</p>
            </motion.div>
          ) : (
            <motion.div
              initial={{ opacity: 0 }}
